### (Bonus) Adding TSDocs to type annotations
...
Fortunately, there are other standards that exist which let us add comments above our function and variable declarations to document them in greater detail. The [TSDoc standard](https://tsdoc.org/) is based on the existing [JSDoc standard](https://jsdoc.app/index.html), but is entirely designed to work with TypeScript.
