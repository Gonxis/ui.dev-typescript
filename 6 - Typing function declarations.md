...
Practice:
[Type Annotations CodeSandbox](https://codesandbox.io/s/practice-type-annotations-m32lj?file=/src/annotations.ts)

[My Solution](https://codesandbox.io/p/devbox/prmywk?file=%2Fsrc%2Fannotations.ts%3A55%2C2)

The solution:
[Type Annotations CodeSandbox Solution](https://codesandbox.io/s/solution-type-annotations-vkk3j?file=/src/annotations.ts)
