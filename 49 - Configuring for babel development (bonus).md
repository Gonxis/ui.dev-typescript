...
For more information on configuring the TypeScript Babel plugin, [check out the Babel docs](https://babeljs.io/docs/en/babel-plugin-transform-typescript#typescript-compiler-options).
