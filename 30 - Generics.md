...
Our array implementation is _exactly the same_, but we have to write it twice because the type signatures are different. What if we were to use a union type?
