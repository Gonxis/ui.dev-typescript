...
This project uses the DOM APIs built into web browsers. If you aren't familiar with creating web apps with DOM APIs, check out [this post](https://fireship.dev/dom) (or Building an app with the Vanilla DOM API (2020) MD) to get up to speed.

The starting point of this video can be found with this [CodeSandbox link](https://githubbox.com/uidotdev/typescript-tic-tac-toe).

You can also find the the [starting point code on Github](https://github.com/uidotdev/typescript-tic-tac-toe). The commit for this video can be found [here](https://github.com/uidotdev/typescript-tic-tac-toe/commit/26e883a3d817012bb12a2d665c7753d1533ede87).
...

{
  ...
  "dependencies": {
    ...
    "htmlnano": {
      "version": "0.2.7",
      "resolved": "https://registry.npmjs.org/htmlnano/-/htmlnano-0.2.7.tgz",
