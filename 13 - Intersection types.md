...
If Union types are either one type _or_ another, Intersection types are one type _and_ another. Intersection types combine the properties and features of two types together. Let's go back to our `Fruit` and `Vegetable` example.
