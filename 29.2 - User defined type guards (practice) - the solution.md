### (Practice) User Defined Type Guards - The Solution

[User Defined Type Guards CodeSandbox Solution](https://codesandbox.io/s/solution-user-defined-type-guards-dnxer?file=/src/userDefinedGuard.ts)


src/userDefinedGuard.ts
```ts
