### (Practice) Discriminating Unions - The Solution

[Discriminating Unions CodeSandbox Solution](https://codesandbox.io/s/solution-discriminating-unions-3gcrl?file=/src/discriminatingUnions.ts)
